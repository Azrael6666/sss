...
<style>
    ...
    * { box-sizing: border-box; scroll-behavior: smooth; }
    ...
    .nav-links a { color: #fff; text-decoration: none;
        margin: 0 15px; font-weight: bold; font-size: 15px; transition: 0.3s; }
    .nav-links a:hover { color: #d4af37; }
    
    .logo { display: flex; align-items: center; gap: 12px; font-size: 26px; font-weight: 900;
        color: #d4af37; text-decoration: none; }
    .logo img { height: 55px; width: 55px; border-radius: 50%;
        border: 1px solid rgba(212, 175, 55, 0.4); object-fit: cover; }

    .content-area { padding: 40px 8%; text-align: center; }
    
    .btn-main { padding: 15px 35px; border-radius: 8px; text-decoration: none; font-weight: bold;
        font-size: 18px; transition: 0.3s; min-width: 220px; display: inline-block; cursor: pointer; border: none; }
    .btn-discord { background: #5865F2;
        color: #fff; border: 2px solid #5865F2; margin: 10px; }
    .btn-cfx-main { background: #d4af37; color: #000;
        border: 2px solid #d4af37; margin: 10px; }
    
    .btn-outline-gold { border: 1px solid #d4af37; color: #d4af37; padding: 12px 45px; border-radius: 30px; text-decoration: none;
        font-size: 16px; transition: 0.3s; display: inline-block; margin-top: 30px; font-weight: bold; }
    .btn-outline-gold:hover { background: #d4af37; color: #000; }

    .experience-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));
        gap: 20px; margin: 50px 0; }
    .exp-card { background: rgba(25, 20, 15, 0.75);
        border: 1px solid rgba(212, 175, 55, 0.2); padding: 40px 20px; border-radius: 12px; transition: 0.3s; }
    ...
    .rule-card:hover { transform: translateY(-8px); box-shadow: 0 10px 25px rgba(212, 175, 55, 0.2);
        border-color: #d4af37; }
    .icon-box { width: 60px; height: 60px; border-radius: 12px; display: flex; align-items: center; justify-content: center;
        font-size: 28px; color: #fff; margin-left: 20px; flex-shrink: 0; }

    .modal { display: none; position: fixed; z-index: 2000;
        left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.92); backdrop-filter: blur(10px); }
    .modal-content { background: #0f0f0f;
        margin: 2% auto; padding: 40px; border: 1px solid #d4af37; border-radius: 15px; width: 90%; max-width: 1000px; max-height: 90vh; overflow-y: auto;
        text-align: right; position: relative; }
    .close-btn { color: #fff; position: absolute; left: 30px; top: 25px; font-size: 35px;
        cursor: pointer; transition: 0.3s; }
    .close-btn:hover { color: #d4af37; }
    
    .modal-content h2 { color: #d4af37; font-size: 32px; border-bottom: 2px solid #222;
        padding-bottom: 15px; margin-bottom: 25px; }
    .modal-content h3 { color: #d4af37; margin-top: 35px; border-right: 4px solid #d4af37;
        padding-right: 15px; background: rgba(212, 175, 55, 0.05); padding: 10px 15px;}
    
    .rules-list { list-style: none; padding: 0; margin: 20px 0; }
    .rules-list li { background: rgba(255,255,255,0.02); margin: 10px 0; padding: 15px;
        border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); line-height: 1.7; color: #ddd; }

    .highlight-box { background: rgba(212,175,55,0.1); padding: 20px;
        border-right: 5px solid #d4af37; border-radius: 8px; margin-bottom: 25px; font-size: 17px; line-height: 1.8; }
    .note-box { color: #ffab00;
        background: rgba(255, 171, 0, 0.1); padding: 20px; border-radius: 10px; font-size: 15px; margin-top: 20px; border: 1px dashed #ffab00; line-height: 1.8; }
    .danger-box { color: #ff4c4c; background: rgba(255, 76, 76, 0.1); padding: 20px; border-radius: 10px; font-size: 15px;
        margin-top: 20px; border: 1px dashed #ff4c4c; line-height: 1.8; }
    ...
    res.send(layout(`
        ...
        <div id="safe-modal" class="modal">
            <div class="modal-content">
                ...
                <ul class="rules-list">
                    <li>1. المستشفيات ومراكز الشرط ومراكز أمن المنشأت.</li>
                    <li>2. معرض المركبات والشاحنات.</li>
                    <li>3. مركز التوظيف ومكان استخراج رخص.</li>
                    <li>4. حجز المركبات والشاحنات.</li>
        ...
        <div id="smuggling-modal" class="modal">
            <div class="modal-content">
                ...
                <ul class="rules-list">
                    <li>- يمنع الهروب سباحة؛ الهروب يكون بالقارب فقط.</li>
                    <li>- في حال وجود 3 مهربين أو أكثر، يمنع على الأمن المواجهة إذا كان عددهم أقل من 3.</li>
                    <li>- يمنع الدخول بـ الدباب او مركبة سوبر او سبورت او طائرات الى الميناء البحري.</li>
                    <li>- يمنع استخدام الاسلحة من القارب ضد اي شخص على رصيف الميناء.</li>
                    <li>- يمنع دخول الميناء بهدف القتال فقط دون وجود ممنوعات.</li>
                </ul>
            </div>
        </div>
        ...
        <div id="crime-modal" class="modal">
            <div class="modal-content">
                ...
                <ul class="rules-list">
                    ...
                    <li>يمنع تحالف العصابات ضد الأمن بشكل عام.</li>
                </ul>
            </div>
        </div>
        ...
        <div id="robbery-modal" class="modal">
            <div class="modal-content">
                ...
                <div class="highlight-box">البنك المركزي: المجرمين 4-6 | الأمن الأقصى 10</div>
                <div class="highlight-box">المتاجر: المجرمين 1-3 | الأمن الأقصى 4</div>
            </div>
        </div>
    `));
});
